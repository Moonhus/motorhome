...
function ListingSummary({ van }: { van: Motorhome }) {
  ...
  return (
    <div>
      <h1 className="display text-[1.7rem] leading-[1.15] text-forest sm:text-3xl">
        {van.title}
      </h1>
...
export default async function ListingPage({
  ...
  return (
    <article className="overflow-x-hidden bg-cream pb-28 lg:pb-20">
      ...
      <div className="mx-auto max-w-6xl px-5 pt-4 sm:pt-6">
        <Link
          href="/inventory"
      ...
      <div className="mx-auto mt-4 grid max-w-6xl items-start lg:mt-6 lg:grid-cols-[minmax(0,1.7fr)_minmax(260px,19.5rem)] lg:gap-12 lg:px-5">
        ...
        <aside className="px-5 pt-5 lg:sticky lg:top-6 lg:self-start lg:px-0 lg:pt-0">
